...
export default function Guest({ children }) {
    ...
    return (
        <div className="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
            <div className="flex w-full justify-between items-stretch max-w-[1440px] bg-white gap-24 h-16 fixed top-0 z-10">
                <Link
                    href="/"
            ...
            <div className="w-full pt-16 px-6 py-4 bg-white overflow-hidden min-h-[100vh]">
                {children}
            </div>
        </div>
    );
