...
export default function MaklumatIndex() {
    return (
        <GuestLayout>
            <Head title="Maklumat Pelayanan" />

            <div className="flex flex-col gap-4 max-w-[1440px] mx-auto my-8 px-6">
                <h1 className="text-3xl md:text-5xl font-serif text-center mt-4 font-semibold">Maklumat Pelayanan PPID Kota Probolinggo</h1>
                ...
                <div className="overflow-auto">
                    <img src="/assets/images/maklumat.jpeg" alt="Maklumat PPID Pemerintahan Kota" className="border shadow-md my-2 rounded-xl min-w-[1024px] mx-auto" />
                </div>
            </div>
        </GuestLayout>
    );
