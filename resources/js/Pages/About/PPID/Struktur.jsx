...
export default function StrukturIndex() {
    return (
        <GuestLayout>
            <Head title="Struktur PPID" />

            <div className="flex flex-col gap-4 max-w-[1440px] mx-auto my-8 px-6">
                <h1 className="text-3xl md:text-5xl font-serif text-center mt-4 font-semibold">Struktur PPID Kota Probolinggo</h1>
                ...
                <div className="overflow-auto">
                    <img src="/assets/images/strukturPPID.jpeg" alt="Struktur Pemerintahan Kota" className="my-2 rounded-xl min-w-[1024px] mx-auto" />
                </div>
            </div>
        </GuestLayout>
    );
