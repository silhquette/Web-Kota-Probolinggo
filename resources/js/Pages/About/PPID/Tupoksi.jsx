...
export default function TupoksiIndex() {
    const tupoksiData = [
        "Merencanakan, melaksanakan, mengkoordinasikan, dan mengendalikan mengumpilkan bahan informasi, mengklasifikasikan informasi, mendokumentasikan informasi dan memberikan pelayanan informasi dari PPID Pembantu;",
    ...
    return (
        <GuestLayout>
            <Head title="Tupoksi PPID" />

            <div className="flex flex-col gap-4 max-w-[1024px] mx-auto my-8 px-6">
                <h1 className="text-3xl md:text-5xl font-serif text-center mt-4 font-semibold">Tupoksi PPID Kota Probolinggo</h1>
