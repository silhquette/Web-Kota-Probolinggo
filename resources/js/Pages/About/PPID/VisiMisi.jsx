    ...
    return (
        <GuestLayout>
            ...
            <div className="flex flex-col gap-4 max-w-[1024px] mx-auto my-8 px-6">
                <h1 className="text-3xl md:text-5xl font-serif text-center mt-4 font-semibold">Visi dan Misi PPID Kota Probolinggo</h1>
                ...
                <div className="flex flex-col gap-2 w-full md:w-2/3 mx-auto">
                    ...
                    <hr />
                    <p className="">Terwujudnya pelayanan informasi yang transparan dan akuntabel untuk memenuhi hak pemohon informasi sesuai dengan ketentuan peraturan perundang-undangan</p>
                    ...
                    <ol className="list-decimal mx-4">
                        ...
                        <li>Membangun dan mengembangkan system penyediaan dan layanan informasi</li>
                        <li>Meningkatkan kopetensi sumberdaya manusia</li>
                    </ol>
                    <h2 className="text-xl md:text-3xl mt-4 font-semibold">Prioritas Pembangunan</h2>
                    <hr />
                    <p className="">Cepat, Tepat, Murah dan Sederhana</p>
                </div>
            </div>
        </GuestLayout>
    );
