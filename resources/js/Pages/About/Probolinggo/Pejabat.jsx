...
export default function InformationIndex({ officers }) {
    ...
    return (
        <GuestLayout>
            <Head title="Daftar Pejabat Kota Probolinggo" />
            ...
            <div className="flex flex-col gap-4 max-w-[1440px] mx-auto my-8 px-6">
                <h1 className="text-3xl md:text-5xl font-serif text-center mt-4 font-semibold">
                    Daftar Pejabat Kota Probolinggo
                </h1>
                        ...
                        <table class="table-auto">
                            <thead>
                                <tr className="border-y">
                                    ...
                                    <th className="py-2">Perangkat Daerah </th>
                                    <th className="py-2">Alamat</th>
                                    <th className="py-2">No.Tlp / Fax</th>
                                    <th className="py-2">Kepala Perangkat Daerah</th>
                                </tr>
                            </thead>
                            <tbody>
                                {officers.map((item, index) => (
                                    <tr key={index} className="border-y">
                                        ...
                                        <td className="py-2 px-4">{item.head}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
