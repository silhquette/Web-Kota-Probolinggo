...
export default function StrukturIndex() {
    return (
        <GuestLayout>
            ...
            <div className="flex flex-col gap-4 max-w-[1440px] mx-auto my-8">
                <h1 className="text-3xl md:text-5xl font-serif text-center mt-4 font-semibold">Struktur Pemerintahan Kota Probolinggo</h1>
                ...
                <div className="overflow-auto">
                    <img src="/assets/images/struktur.jpg" alt="Struktur Pemerintahan Kota" className="my-2 rounded-xl min-w-[1024px]" />
                </div>
            </div>
        </GuestLayout>
    );
