...
export default function InformationIndex({ informations }) {
    ...
    return (
        <GuestLayout>
            <Head title="Daftar Informasi Dikecualikan Penetapan dan Proses Uji Konsekuensi" />
            ...
            <div className="flex flex-col gap-4 max-w-[1024px] mx-auto my-8 px-6">
                <h1 className="text-3xl md:text-5xl font-serif text-center mt-4 font-semibold">
                    Daftar Informasi Dikecualikan Penetapan dan Proses Uji Konsekuensi
                </h1>
                        ...
                        <table class="table-auto w-full">
                            {  
                                (informations.length == 0) ? (<>
                                    ...
                                    <tbody>
                                        <td colSpan={7}><div className="w-full text-center py-4">Belum ada data.</div></td>
                                    </tbody>
                                </>) : null 
                            }
                            <tbody>
