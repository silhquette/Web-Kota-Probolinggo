            ...
            <div className="flex flex-col gap-6 max-w-[1440px] mx-auto px-6">
                ...
                <div className="max-w-full md:max-w-[1024px] mx-auto flex flex-col md:flex-row gap-12 items-stretch justify-center">
                    <div className="basis-2/3 group">
                        <a href="https://probolinggokota.go.id/" className="p-4 border shadow rounded-xl inline-block w-full overflow-hidden"><img src="/assets/images/logo-probolinggo.png" className="w-full group-hover:scale-[1.02] transition-all" alt="" /></a>
                    ...
                    <div className="basis-1/3 group">
                        <a href="https://handal.lapor.go.id/" className="p-4 border shadow rounded-xl inline-block w-full overflow-hidden"><img src="/assets/images/logo-span.png" className="w-full group-hover:scale-[1.05] transition-all" alt="" /></a>
