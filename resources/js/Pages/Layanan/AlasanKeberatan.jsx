...
export default function AlasanIndex() {
    return (
        <GuestLayout>
            <Head title="Pengajuan Keberatan" />

            <div className="flex flex-col gap-4 max-w-[1440px] mx-auto my-8 px-6">
                <h1 className="text-3xl md:text-5xl font-serif text-center mt-4 font-semibold">Alasan Pengajuan Keberatan</h1>
                ...
                <div className="overflow-auto">
                    <img src="/assets/images/alasan-keberatan.jpeg" alt="Alasan pengajuan keberatan" className="border shadow-md my-2 rounded-xl min-w-[1024px] mx-auto" />
                </div>
            </div>
        </GuestLayout>
    );
